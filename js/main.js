...
function loadConfig() {
    ...
    if (document.getElementById('config-os-endereco')) document.getElementById('config-os-endereco').value = config.osEndereco || 'AVENIDA SOUZA NAVES - 991, IVAIPORÃ-PR';
    if (document.getElementById('config-os-complemento')) document.getElementById('config-os-complemento').value = config.osComplemento || 'COMPLEMENTO: AO LADO DO BOMFIM CALÇADOS';
    if (document.getElementById('config-os-telefone')) document.getElementById('config-os-telefone').value = config.osTelefone || '(43) 99969-1521';
    if (document.getElementById('config-os-email')) document.getElementById('config-os-email').value = config.osEmail || 'avencecellivp@gmail.com';
...
btnSalvarConfig.addEventListener('click', async () => {
    ...
    const config = {
        ...
        osTitulo: document.getElementById('config-os-titulo') ? document.getElementById('config-os-titulo').value : 'AVENCE CELL',
        osAssinatura: document.getElementById('config-os-assinatura') ? document.getElementById('config-os-assinatura').value : 'AVENCE CELL',
        osEndereco: document.getElementById('config-os-endereco') ? document.getElementById('config-os-endereco').value : 'AVENIDA SOUZA NAVES - 991, IVAIPORÃ-PR',
        osComplemento: document.getElementById('config-os-complemento') ? document.getElementById('config-os-complemento').value : 'COMPLEMENTO: AO LADO DO BOMFIM CALÇADOS',
...
if (btnFinalizarCheckout) {
    btnFinalizarCheckout.addEventListener('click', async () => {
        ...
        if (document.getElementById('pd_store_email')) document.getElementById('pd_store_email').textContent = config.osEmail || 'avencecellivp@gmail.com';
...
btnFinalizarImprimir.addEventListener('click', async (e) => {
    ...
    document.getElementById('pi-titulo').textContent = config.osTitulo || 'AVENCE CELL';
    document.getElementById('pi-endereco').textContent = config.osEndereco || 'AVENIDA SOUZA NAVES - 991, IVAIPORÃ-PR';
    document.getElementById('pi-complemento').textContent = config.osComplemento || 'COMPLEMENTO: AO LADO DO BOMFIM CALÇADOS';
    document.getElementById('pi-telefone-email').textContent = `${config.osTelefone || '(43) 99969-1521'}  ${config.osEmail || 'avencecellivp@gmail.com'}`;
    ...
    document.getElementById('pi-assinatura-loja').textContent = config.osAssinatura || 'AVENCE CELL';
