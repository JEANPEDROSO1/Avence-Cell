...
if (btnFinalizarVenda) {
    btnFinalizarVenda.addEventListener('click', async () => {
        ...
        const lojaNome = cfg.storeName || cfg.osTitulo || cfg.nome || 'AVENCE CELL';
        const lojaEnd = cfg.osEndereco || cfg.endereco || 'AVENIDA SOUZA NAVES - 991, IVAIPORÃ-PR';
        const lojaComp = cfg.osComplemento || 'AO LADO DO BONFIM CALÇADOS';
        const lojaTel = cfg.osTelefone || cfg.telefone || '(43) 99969-1521';
        const lojaEmail = cfg.osEmail || cfg.email || 'AVENCECELLIVP@GMAIL.COM';
